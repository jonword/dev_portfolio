...
const Home = () => {
  return (
    <div className="h-screen w-full" id="home">
      {/* CONTAINER */}
      <div className="mx-auto flex h-full max-w-[1000px] flex-col justify-center px-40">
        ...
        <p className="max-w-[700px] shrink flex-wrap py-4 text-white">
          I'm a self taught front-end developer passionate in creating a clean
          UI experience. I'm focused on building fully responsive web
          applications.
        </p>
      </div>
    </div>
